...
*Generated by ContextKit check-accessibility agent - ensuring inclusive design from day one*
```
...
- Integrates with build-project agent for comprehensive code quality
